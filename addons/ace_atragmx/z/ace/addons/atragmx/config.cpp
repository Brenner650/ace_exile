////////////////////////////////////////////////////////////////////
//DeRap: ace_atragmx\config.bin
//Produced from mikero's Dos Tools Dll version 6.44
//'now' is Tue Jun 05 23:43:53 2018 : 'file' last modified on Mon Apr 16 21:41:06 2018
...
class Extended_PreStart_EventHandlers
{
	class ace_atragmx
	{
		init = "call compile preProcessFileLineNumbers '\z\ace\addons\atragmx\XEH_preStart.sqf'";
	};
};
...
class ATragMX_Display
{
	...
	onUnload = "_this call ace_atragmx_fnc_on_close_dialog";
	movingEnable = 1;
	controlsBackground[] = {};
	objects[] = {};
	class controls
	{
		class BACKGROUND
		{
			...
			colorBackground[] = {1,1,1,1};
			colorText[] = {1,1,1,1};
			text = "\z\ace\addons\atragmx\UI\atrag_d.paa";
		};
		...
		class TEXT_MUZZLE_VELOCITY: ATragMX_RscButton
		{
			...
			colorFocused[] = {0.15,0.21,0.23,0.2};
			text = "MV";
			action = "0 call ace_atragmx_fnc_toggle_muzzle_velocity_data";
		};
		...
		class TEXT_OPTIONS: TEXT_GUN_LIST
		{
			...
			x = "0.550*safezoneW+safezoneX+0.3";
			text = "Options";
			action = "false call ace_atragmx_fnc_toggle_option_menu";
		};
		...
		class TEXT_OPTIONS_LIST_OUTPUT: ATragMX_RscListBox
		{
			...
			y = "0.265*safezoneH+safezoneY+0.355";
			sizeEx = 0.025;
			onMouseButtonClick = "true call ace_atragmx_fnc_toggle_option_menu";
		};
		...
		class TEXT_GUN_LIST_OUTPUT: ATragMX_RscListNBox
		{
			...
			onLBDblClick = "true call ace_atragmx_fnc_toggle_gun_list";
		};
		...
		class TEXT_ADD_NEW_GUN_GUN_NAME_INPUT: ATragMX_RscEdit
		{
			...
			y = "0.265*safezoneH+safezoneY+0.28";
			text = "";
			onKeyDown = "call ace_atragmx_fnc_trim_gun_name";
			onKeyUp = "call ace_atragmx_fnc_trim_gun_name";
		};
		...
		class TEXT_MUZZLE_VELOCITY_DATA_CLEAR: TEXT_TARGET_DATA_NEXT
		{
			...
			text = "Clear";
			action = "call ace_atragmx_fnc_clear_muzzle_velocity_data";
		};
		...
		{
			idc = 16006;
			action = "1 call ace_atragmx_fnc_toggle_muzzle_velocity_data";
		};
		...
		class TEXT_C1_BALLISTIC_COEFFICIENT_DATA_CLEAR: TEXT_C1_BALLISTIC_COEFFICIENT_DATA_QUESTIONMARK
		{
			...
			text = "Clear";
			action = "call ace_atragmx_fnc_clear_c1_ballistic_coefficient_data";
		};
		class TEXT_C1_BALLISTIC_COEFFICIENT_DATA_DONE: TEXT_TARGET_DATA_DONE
		{
			idc = 17006;
			action = "1 call ace_atragmx_fnc_toggle_c1_ballistic_coefficient_data";
		};
		class TEXT_C1_BALLISTIC_COEFFICIENT_DATA_CANCEL: TEXT_TARGET_DATA_CANCEL
		{
			idc = 17007;
			action = "0 call ace_atragmx_fnc_toggle_c1_ballistic_coefficient_data";
		};
		...
		class TEXT_TRUING_DROP_SUPER: TEXT_TARGET_A
		{
			...
			text = "SUPER";
			action = "ace_atragmx_truingDropMode= 0; call ace_atragmx_fnc_update_truing_drop_selection";
		};
		class TEXT_TRUING_DROP_SUB: TEXT_TRUING_DROP_SUPER
		{
			...
			x = "0.550*safezoneW+safezoneX+0.32";
			text = "SUB";
			action = "ace_atragmx_truingDropMode= 1; call ace_atragmx_fnc_update_truing_drop_selection";
		};
		...
		class TEXT_TRUING_DROP_CALC: TEXT_GUN_LIST
		{
			...
			y = "0.265*safezoneH+safezoneY+0.45";
			text = "Calc";
			action = "true call ace_atragmx_fnc_calculate_truing_drop";
		};
		...
		class TEXT_TRUING_DROP_ACCEPT: TEXT_GUN_LIST
		{
			...
			y = "0.265*safezoneH+safezoneY+0.60";
			text = "Accept";
			action = "1 call ace_atragmx_fnc_toggle_truing_drop";
		};
		class TEXT_TRUING_DROP_CANCEL: TEXT_TRUING_DROP_ACCEPT
		{
			...
			text = "Cancel";
			action = "0 call ace_atragmx_fnc_toggle_truing_drop";
		};
		class TEXT_TRUING_DROP_RESTORE: TEXT_TRUING_DROP_CANCEL
		{
			...
			text = "Restore";
			action = "true call ace_atragmx_fnc_restore_truing_drop";
		};
	};
};
