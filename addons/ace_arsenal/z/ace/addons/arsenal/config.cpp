////////////////////////////////////////////////////////////////////
//DeRap: ace_arsenal\config.bin
//Produced from mikero's Dos Tools Dll version 6.44
//'now' is Tue Jun 05 23:43:53 2018 : 'file' last modified on Mon Apr 16 21:41:05 2018
...
class Display3DEN
{
	class ContextMenu: ctrlMenu
	{
		class Items
		{
			...
			{
				text = "ACE Arsenal";
				action = "call ace_arsenal_fnc_open3DEN";
			};
		};
	};
	class Controls
	{
		class MenuStrip: ctrlMenuStrip
		{
			class Items
			{
				...
				{
					text = "$STR_ace_arsenal_portLoadoutsText";
...
class ace_arsenal_display
{
	idd = 1127001;
	enableSimulation = 1;
	onLoad = "['onLoad',_this,""ace_arsenal_display""] call ace_arsenal_fnc_onArsenalOpen";
	onUnload = "['onUnload',_this,""ace_arsenal_display""] call ace_arsenal_fnc_onArsenalClose";
	onKeyDown = "['onKeyDown',_this,""ace_arsenal_display""] call ace_arsenal_fnc_onKeyDown";
	onKeyUp = "ace_arsenal_shiftState= _this select 2";
	onMouseButtonDown = "['onMouseButtonDown',_this,""ace_arsenal_display""] call ace_arsenal_fnc_onMouseButtonDown";
	onMouseButtonUp = "['onMouseButtonUp',_this,""ace_arsenal_display""] call ace_arsenal_fnc_onMouseButtonUp";
	...
	class ControlsBackground
	{
		...
		class mouseArea: ctrlStatic
		{
			idc = 0;
			style = 16;
			onMouseMoving = "['onMouseMoving',_this,ace_arsenal_display] call ace_arsenal_fnc_handleMouse";
			onMouseHolding = "['onMouseHolding',_this,ace_arsenal_display] call ace_arsenal_fnc_handleMouse";
			onMouseZChanged = "['onMouseZChanged',_this,ace_arsenal_display] call ace_arsenal_fnc_handleScrollWheel";
			x = "safezoneX";
			y = "safezoneY";
			w = "safezoneW";
			h = "safezoneH";
	...
	class controls
	{
		class ArrowLeft: ctrlButton
		{
			...
			onButtonClick = "[ctrlParent (_this select 0),-1] call ace_arsenal_fnc_buttonCargo";
			fade = 1;
			enable = 0;
			x = 0.5;
			y = 0.5;
		...
		class menuBar: RscControlsGroupNoScrollbars
		{
			...
			class controls
			{
				class buttonHide: ctrlButton
				{
					...
					h = "7 * (pixelH * pixelGridNoUIScale * 0.25)";
					text = "$STR_ace_arsenal_buttonHideText";
					sizeEx = "5 * (pixelH * pixelGridNoUIScale * 0.25)";
					shortcuts[] = {"0x0E"};
					tooltip = "$STR_ace_arsenal_buttonHideTooltip";
					onButtonClick = "[ctrlParent (_this select 0)] call ace_arsenal_fnc_buttonHide";
				};
				class buttonLoadouts: buttonHide
				{
					...
					text = "$STR_ace_arsenal_buttonLoadoutsText";
					tooltip = "$STR_ace_arsenal_buttonLoadoutsTooltip";
					onButtonClick = "createDialog ""ace_arsenal_loadoutsDisplay""";
				};
				class buttonExport: buttonHide
				{
					...
					text = "$STR_ace_arsenal_buttonExportText";
					tooltip = "$STR_ace_arsenal_buttonExportTooltip";
					onButtonClick = "[ctrlParent (_this select 0)] call ace_arsenal_fnc_buttonExport";
				};
				class buttonImport: buttonHide
				{
					...
					text = "$STR_ace_arsenal_buttonImportText";
					tooltip = "$STR_ace_arsenal_buttonImportTooltip";
					onButtonClick = "[ctrlParent (_this select 0)] call ace_arsenal_fnc_buttonImport";
				};
				class buttonClose: ctrlButtonOK
				{
					...
					w = "(((safezoneW - 2 * (93 * (pixelW * pixelGridNoUIScale * 0.25)))- 6 * ((safezoneW - 2 * (93 * (pixelW * pixelGridNoUIScale * 0.25)))/ 100)) / 5)";
					h = "7 * (pixelH * pixelGridNoUIScale * 0.25)";
					text = "$STR_ace_arsenal_buttonCloseText";
					sizeEx = "5 * (pixelH * pixelGridNoUIScale * 0.25)";
		...
		class statsButton: ctrlButton
		{
			...
			style = 2;
			text = ">";
			onButtonClick = "[""ace_arsenal_statsButton"",[ctrlParent (_this select 0)]]call CBA_fnc_localEvent";
			x = "(0.5 - (safezoneW - 2 * (93 * (pixelW * pixelGridNoUIScale * 0.25)))/ 2) + ((safezoneW - 2 * (93 * (pixelW * pixelGridNoUIScale * 0.25)))/ 100)";
			y = "safezoneY + 1.8 * (pixelH * pixelGridNoUIScale * 0.25)";
		...
		class statsPreviousPage: ctrlButton
		{
			...
			onButtonClick = "[""ace_arsenal_statsChangePage"",[ctrlParent (_this select 0),_this select 0,false]]call CBA_fnc_localEvent";
			x = "(0.5 - (safezoneW - 2 * (93 * (pixelW * pixelGridNoUIScale * 0.25)))/ 2) + ((safezoneW - 2 * (93 * (pixelW * pixelGridNoUIScale * 0.25)))/ 100)";
			y = "safezoneY + 1.8 * (pixelH * pixelGridNoUIScale * 0.25)";
		...
		class statsNextPage: statsPreviousPage
		{
			idc = 53;
			text = ">";
			onButtonClick = "[""ace_arsenal_statsChangePage"",[ctrlParent (_this select 0),_this select 0,true]]call CBA_fnc_localEvent";
		...
		class leftTabContent: RscListBox
		{
			...
			onLBSelChanged = "_this call ace_arsenal_fnc_onSelChangedLeft";
			onSetFocus = "ace_arsenal_leftTabFocus= true";
			onKillFocus = "ace_arsenal_leftTabFocus= false";
			x = "safezoneX + 13 * (pixelW * pixelGridNoUIScale * 0.25)";
			y = "safezoneY + 14 * (pixelH * pixelGridNoUIScale * 0.25)";
			w = "80 * (pixelW * pixelGridNoUIScale * 0.25)";
		...
		class rightTabContent: leftTabContent
		{
			...
			drawSideArrows = 1;
			disableOverflow = 1;
			onLBSelChanged = "_this call ace_arsenal_fnc_onSelChangedRight";
			onSetFocus = "ace_arsenal_rightTabFocus= true";
			onKillFocus = "ace_arsenal_rightTabFocus= false";
			x = "safezoneX + safezoneW - 93 * (pixelW * pixelGridNoUIScale * 0.25)";
			h = "safezoneH - 34.5 * (pixelH * pixelGridNoUIScale * 0.25)";
		};
		class rightTabContentListnBox: RscListNBox
		{
			...
			drawSideArrows = 1;
			disableOverflow = 1;
			onLBSelChanged = "_this call ace_arsenal_fnc_onSelChangedRightListnBox";
			onSetFocus = "ace_arsenal_rightTabLnBFocus= true";
			onKillFocus = "ace_arsenal_rightTabLnBFocus= false";
			x = "safezoneX + safezoneW - 93 * (pixelW * pixelGridNoUIScale * 0.25)";
			y = "safezoneY + 14 * (pixelH * pixelGridNoUIScale * 0.25)";
			w = "80 * (pixelW * pixelGridNoUIScale * 0.25)";
			h = "safezoneH - 34.5 * (pixelH * pixelGridNoUIScale * 0.25)";
		...
		class sortLeftTab: RscCombo
		{
			...
			w = "80 * (pixelW * pixelGridNoUIScale * 0.25)";
			h = "6 * (pixelH * pixelGridNoUIScale * 0.25)";
			onLBSelChanged = "_this call ace_arsenal_fnc_sortPanel";
			sizeEx = "5 * (pixelH * pixelGridNoUIScale * 0.25)";
			class Items
			{
				class Alphabet
		...
		{
			idc = 18;
			onSetFocus = "ace_arsenal_leftSearchbarFocus= true";
			onKillFocus = "ace_arsenal_leftSearchbarFocus= false";
			onMouseButtonClick = "[ctrlParent (_this select 0),_this select 0,_this select 1] call ace_arsenal_fnc_clearSearchbar";
			x = "safezoneX + 13 * (pixelW * pixelGridNoUIScale * 0.25)";
			y = "safezoneY + 1.8 * (pixelH * pixelGridNoUIScale * 0.25)";
		...
		class leftSearchbarButton: ctrlButtonPicture
		{
			...
			colorBackground[] = {0,0,0,0.5};
			onButtonClick = "[ctrlParent (_this select 0),ctrlParent (_this select 0) displayCtrl 18] call ace_arsenal_fnc_handleSearchbar";
		...
		{
			idc = 19;
			onSetFocus = "ace_arsenal_rightSearchbarFocus= true";
			onKillFocus = "ace_arsenal_rightSearchbarFocus= false";
			x = "safezoneX + safezoneW - 87 * (pixelW * pixelGridNoUIScale * 0.25)";
		};
		class rightSearchbarButton: leftSearchbarButton
		{
			idc = 42;
			onButtonClick = "[ctrlParent (_this select 0),ctrlParent (_this select 0) displayCtrl 19] call ace_arsenal_fnc_handleSearchbar";
			x = "safezoneX + safezoneW - 93 * (pixelW * pixelGridNoUIScale * 0.25)";
		};
		class tabLeft: RscControlsGroupNoScrollbars
		{
			...
			class controls
			{
				...
				class buttonPrimaryWeapon: RscButtonArsenal
				{
					...
					onButtonClick = "[ctrlParent (_this select 0),_this select 0] call ace_arsenal_fnc_fillLeftPanel";
					colorBackground[] = {0,0,0,0.5};
					x = "0 * (pixelW * pixelGridNoUIScale * 0.25)";
					y = "0 * (pixelH * pixelGridNoUIScale * 0.25)";
		...
		class buttonOptic: RscButtonArsenal
		{
			...
			onButtonClick = "[ctrlParent (_this select 0),_this select 0] call ace_arsenal_fnc_fillRightPanel";
			colorBackground[] = {0,0,0,0.5};
		...
		class buttonCurrentMag: buttonOptic
		{
			...
			tooltip = "$STR_ace_arsenal_buttonCurrentMagTooltip";
			y = "safezoneY + 48 * (pixelH * pixelGridNoUIScale * 0.25)";
		};
		...
		{
			idc = 3004;
			text = "\z\ace\addons\arsenal\data\iconSecondaryMuzzle";
			tooltip = "$STR_ace_arsenal_buttonCurrentMag2Tooltip";
			y = "safezoneY + 58 * (pixelH * pixelGridNoUIScale * 0.25)";
		};
		...
		{
			idc = 40;
			text = "\z\ace\addons\arsenal\data\iconClearContainer.paa";
			tooltip = "$STR_ace_arsenal_buttonClearContainerTooltip";
			colorBackground[] = {0,0,0,0.5};
			onButtonClick = "ctrlParent (_this select 0) call ace_arsenal_fnc_buttonClearAll";
			fade = 1;
			enable = 0;
...
{
	idd = 1127002;
	onLoad = "['onLoad',_this,""ace_arsenal_loadoutsDisplay""] call ace_arsenal_fnc_onLoadoutsOpen";
	onUnload = "['onUnload',_this,""ace_arsenal_loadoutsDisplay""] call ace_arsenal_fnc_onLoadoutsClose";
	class controls
	{
		class centerBox: ctrlControlsGroupNoScrollbars
		{
			...
			class controls
			{
				...
				class contentPanel: RscListnBox
				{
					...
					drawSideArrows = 0;
					disableOverflow = 1;
					onSetFocus = "ace_arsenal_loadoutsPanelFocus= true";
					onKillFocus = "ace_arsenal_loadoutsPanelFocus= false";
					onLBSelChanged = "[ctrlParent (_this select 0),_this select 0,_this select 1] call ace_arsenal_fnc_onSelChangedLoadouts";
					onLBDblClick = "[ctrlParent (_this select 0),(ctrlParent (_this select 0)) displayCtrl 305] call ace_arsenal_fnc_buttonLoadoutsLoad";
					x = "0";
					y = "5 * (pixelH * pixelGridNoUIScale * 0.25)";
					w = "160 * (pixelW * pixelGridNoUIScale * 0.25)";
				...
				{
					idc = 309;
					onSetFocus = "ace_arsenal_loadoutsSearchbarFocus= true";
					onKillFocus = "ace_arsenal_loadoutsSearchbarFocus= false";
					onMouseButtonClick = "[ctrlParent (_this select 0),_this select 0,_this select 1] call ace_arsenal_fnc_clearSearchbar";
				...
				class loadoutsSearchbarButton: ctrlButtonPicture
				{
					...
					text = "\a3\Ui_f\data\GUI\RscCommon\RscButtonSearch\search_start_ca.paa";
					colorBackground[] = {0,0,0,0.5};
					onButtonClick = "[ctrlParent (_this select 0),ctrlParent (_this select 0) displayCtrl 309] call ace_arsenal_fnc_handleLoadoutsSearchbar";
				...
				class buttonSave: ctrlButton
				{
					...
					w = "30 * (pixelW * pixelGridNoUIScale * 0.25)";
					h = "10 * (pixelH * pixelGridNoUIScale * 0.25)";
					text = "$STR_ace_arsenal_buttonSaveText";
					tooltip = "$STR_ace_arsenal_buttonSaveTooltip";
					sizeEx = "5 * (pixelH * pixelGridNoUIScale * 0.25)";
					onButtonClick = "[ctrlParent (_this select 0),_this select 0] call ace_arsenal_fnc_buttonLoadoutsSave";
					colorBackground[] = {0,0,0,0.8};
				};
				class buttonRename: buttonSave
				{
					...
					text = "$STR_ace_arsenal_buttonRenameText";
					tooltip = "$STR_ace_arsenal_buttonRenameTooltip";
					onButtonClick = "[ctrlParent (_this select 0),_this select 0] call ace_arsenal_fnc_buttonLoadoutsRename";
				};
				class buttonLoad: buttonSave
				{
					idc = 305;
					x = "65 * (pixelW * pixelGridNoUIScale * 0.25)";
					text = "$STR_ace_arsenal_buttonLoadText";
					tooltip = "$STR_ace_arsenal_buttonLoadTooltip";
					onButtonClick = "[ctrlParent (_this select 0),_this select 0] call ace_arsenal_fnc_buttonLoadoutsLoad";
				};
				class buttonShare: buttonSave
				{
					idc = 306;
					x = "97.5 * (pixelW * pixelGridNoUIScale * 0.25)";
					text = "$STR_ace_arsenal_buttonSharePrivateText";
					tooltip = "$STR_ace_arsenal_buttonShareTooltip";
					onButtonClick = "[ctrlParent (_this select 0),_this select 0] call ace_arsenal_fnc_buttonLoadoutsShare";
				};
				class buttonDelete: buttonSave
				{
					idc = 307;
					x = "130 * (pixelW * pixelGridNoUIScale * 0.25)";
					text = "$STR_ace_arsenal_buttonDeleteText";
					tooltip = "$STR_ace_arsenal_buttonDeleteTooltip";
					colorBackgroundActive[] = {0.5,0,0,1};
					onButtonClick = "[ctrlParent (_this select 0),_this select 0] call ace_arsenal_fnc_buttonLoadoutsDelete";
				};
			};
		};
		...
		class buttonBar: ctrlControlsGroupNoScrollbars
		{
			...
			class controls
			{
				...
				class buttonMyLoadouts: ctrlButton
				{
					...
					h = "7 * (pixelH * pixelGridNoUIScale * 0.25)";
					sizeEx = "5 * (pixelH * pixelGridNoUIScale * 0.25)";
					text = "$STR_ace_arsenal_tabMyLoadoutsText";
					tooltip = "$STR_ace_arsenal_tabMyLoadoutsTooltip";
					onButtonClick = "[ctrlParent (_this select 0),_this select 0] call ace_arsenal_fnc_loadoutsChangeTab";
				};
				...
				class buttonDefaultLoadouts: buttonMyLoadouts
				{
					idc = 404;
					x = "54.5 * (pixelW * pixelGridNoUIScale * 0.25)";
					text = "$STR_ace_arsenal_tabDefaultLoadoutsText";
					tooltip = "$STR_ace_arsenal_tabDefaultLoadoutsTooltip";
				};
				...
				class buttonSharedLoadouts: buttonMyLoadouts
				{
					idc = 406;
					x = "109 * (pixelW * pixelGridNoUIScale * 0.25)";
					text = "$STR_ace_arsenal_tabSharedLoadoutsText";
					tooltip = "$STR_ace_arsenal_tabSharedLoadoutsTooltip";
				};
			};
		};
	};
...
class Extended_PreStart_EventHandlers
{
	class ace_arsenal
	{
		init = "call compile preProcessFileLineNumbers '\z\ace\addons\arsenal\XEH_preStart.sqf'";
	};
};
class Extended_PreInit_EventHandlers
{
	class ace_arsenal
	{
		init = "call compile preProcessFileLineNumbers '\z\ace\addons\arsenal\XEH_preInit.sqf'";
	};
};
class Extended_PostInit_EventHandlers
{
	class ace_arsenal
	{
		init = "call compile preProcessFileLineNumbers '\z\ace\addons\arsenal\XEH_postInit.sqf'";
	};
};
...
class ace_arsenal_stats
{
	...
	{
		scope = 2;
		displayName = "$STR_ace_arsenal_statPotassium";
		showBar = 1;
		barStatement = "1";
	...
	class ACE_mass: statBase
	{
		...
		showText = 1;
		textStatement = "[_this select 0,_this select 1] call ace_arsenal_fnc_statTextStatement_mass";
	...
	class ACE_rateOfFire: statBase
	{
		...
		showBar = 1;
		showText = 1;
		barStatement = "[(_this select 0) select 0,_this select 1,[[-1.4,0.31],[1,0.01],true]] call ace_arsenal_fnc_statBarStatement_default";
		textStatement = "[(_this select 0) select 0,_this select 1,[[-1.4,0.31],false]] call ace_arsenal_fnc_statTextStatement_rateOfFire";
		tabs[] = {{0,1},{}};
	};
	class ACE_accuracy: statBase
	{
		...
		showBar = 1;
		showText = 1;
		barStatement = "[(_this select 0) select 0,_this select 1,[[-4,-1.7],[1,0.01],true]] call ace_arsenal_fnc_statBarStatement_default";
		textStatement = "[(_this select 0) select 0,_this select 1,[[-4,-1.7],false]] call ace_arsenal_fnc_statTextStatement_accuracy";
		tabs[] = {{0,1},{}};
	};
	class ACE_maxZeroing: statBase
	{
		...
		showBar = 1;
		barStatement = "[(_this select 0) select 0,_this select 1,[[0,2500],[0.01,1],false]] call ace_arsenal_fnc_statBarStatement_default";
		tabs[] = {{0,1,2},{}};
	};
	class ACE_impact: statBase
	{
		...
		showBar = 1;
		barStatement = "[_this select 0,_this select 1,[[0,3.2],[-1,1100],2006]] call ace_arsenal_fnc_statBarStatement_impact";
		tabs[] = {{0,1,2},{}};
	};
	class ACE_scopeMagnification: statBase
	{
		scope = 2;
		priority = 2;
		displayName = "$STR_ace_arsenal_statMagnification";
		showText = 1;
		textStatement = "call ace_arsenal_fnc_statTextStatement_scopeMag";
		tabs[] = {{},{0}};
	};
	class ACE_ballisticProtection: statBase
	{
		...
		showBar = 1;
		barStatement = "[(_this select 0) select 0,_this select 1,[[0,0.63],[0.01,1],false]] call ace_arsenal_fnc_statBarStatement_default";
		tabs[] = {{3,4,6},{}};
	};
	class ACE_explosiveResistance: statBase
	{
		...
		showBar = 1;
		barStatement = "[(_this select 0) select 0,_this select 1,[[0,0.80],[0.01,1],false]] call ace_arsenal_fnc_statBarStatement_default";
		tabs[] = {{3,4,6},{}};
	};
